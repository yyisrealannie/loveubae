...
(function (global) {
    ...
    function buildModuleSkipPatterns(flags) {
        ...
        if (!flags.inclCustom) p.push('customReplies', 'customPokes', 'myPokes', 'customStatuses', 'customMottos', 'customIntros', 'customEmojis', 'customReplyGroups', 'customPokeGroups', 'customStatusGroups');
